    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            ViewBag.StatusMessage =
                ...
                : !UserManager.FindById(userId).EmailConfirmed ? "Você ainda não confirmou se e-mail, algumas operçaões não poderam ser realizadas dentro do site."
                : message == ManageMessageId.CadastroAtualizado ? "Cadastro atualizado."
                : "";
            ...
            var model = new IndexViewModel
            {
                ...
                Cliente = ApplicationDbContext.Create().Clientes.FirstOrDefault(c => c.ApplicationUserId == userId)
        };
        ...
        public async Task<ActionResult> VerifyPhoneNumber(string phoneNumber)
        {
            ...
            // Enviar um SMS através do provedor de SMS para verificar o número de telefone
        ...
        public async Task<ActionResult> VerifyPhoneNumber(VerifyPhoneNumberViewModel model)
        {
            ...
            // Se chegarmos até aqui, algo falhou, redisplay formulário
